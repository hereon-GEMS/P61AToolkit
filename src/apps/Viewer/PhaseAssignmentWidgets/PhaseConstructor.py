...
class PhaseConstructor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.a_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=20., singleStep=0.1, decimals=7, suffix=' Å')
        self.b_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=20., singleStep=0.1, decimals=7, suffix=' Å')
        self.c_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=20., singleStep=0.1, decimals=7, suffix=' Å')
        self.alp_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=180., decimals=7, suffix='°')
        self.bet_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=180., decimals=7, suffix='°')
        self.gam_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=180., decimals=7, suffix='°')
        self.tth_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=20., singleStep=0.1, decimals=7, suffix='°')
        self.emax_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=200., decimals=3, suffix=' keV')
        self.de_edt = QDoubleSpinBox(parent=self, minimum=0., maximum=2., singleStep=0.01, decimals=3, suffix=' keV')
        ...
        self.alp_edt.valueChanged.connect(self.on_alp_changed)
        self.bet_edt.valueChanged.connect(self.on_bet_changed)
        self.gam_edt.valueChanged.connect(self.on_gam_changed)
    ...
    def refine_tth(self):
        ...
        try:
            new_tth = least_squares(residuals, [phase.tth], bounds=(0., 20.)).x[0]
